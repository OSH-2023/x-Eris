...
其他 Unix 虚拟文件系统包括 [System V Release 3][https://en.wikipedia.org/wiki/UNIX_System_V] 中的文件系统开关、[Ultrix][https://en.wikipedia.org/wiki/Ultrix] 中的通用文件系统以及 Linux 中的 VFS。在 [OS/2][https://en.wikipedia.org/wiki/OS/2和 Microsoft Windows 中，虚拟文件系统机制被称为可安装文件系统（Installable File System）。
