...
7. You can now use arm-none-eabi-gdb to start a command line debug session, although my preference is to start a graphical debug session, as described next for those using the Eclipse IDE.
